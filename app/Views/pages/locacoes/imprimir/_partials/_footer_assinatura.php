...
<table class="assinatura-table" cellpadding="0" cellspacing="0" style="width: 100%; margin-top: 0;">
    <tr>
        <td class="assinatura-cell" style="width: 45%; text-align: center; vertical-align: bottom; padding: 0 10px;">
            ...
            <img src="<?= $assinaturaPath ?>" alt="<?= t('modules.locacoes.pdf.signature_alt') ?>" class="assinatura-img" style="max-height: 50px; margin-bottom: 5px; background: #fff;">
            <?php endif; ?>
            ...
            <div class="assinatura-nome" style="text-align: center; font-size: 8pt; padding-top: 5px;"><?= htmlspecialchars($locacao['cliente_nome_completo'] ?? t('modules.locacoes.pdf.client_fallback')) ?></div>
        </td>
...
<div class="page-number" style="text-align: center; font-size: 8pt; color: #999; margin-top: 8px;"><?= t('modules.locacoes.pdf.page_label', ['page' => '{PAGENO}', 'total' => '{nbpg}']) ?></div>
