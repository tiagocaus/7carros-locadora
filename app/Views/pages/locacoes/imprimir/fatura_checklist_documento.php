...
<head>
    <meta charset="UTF-8">
    <title><?= t('modules.locacoes.print.invoice_checklist_document') ?> - <?= t('modules.locacoes.print.rental_label') ?> <?= htmlspecialchars($locacao['codigo']) ?></title>
    <style>
...
<body>
    <htmlpageheader name="documento_header">
        <?php $_docTitulo = t('modules.locacoes.pdf.document_title'); include __DIR__ . '/_partials/_header.php'; ?>
    </htmlpageheader>
