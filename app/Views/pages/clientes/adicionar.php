...
<script>
    (function() {
        const i18n = {
            viewTitle: <?= $jsText(t("modules.clientes.view_title_page")) ?>,
            editTitle: <?= $jsText(t("modules.clientes.edit_title")) ?>,
            unsupportedPhotoFormat: <?= $jsText(t("modules.clientes.messages.unsupported_photo_format")) ?>,
            fileTooLarge: <?= $jsText(t("modules.clientes.messages.file_too_large")) ?>,
            cameraNotSupported: <?= $jsText(t("modules.clientes.messages.camera_not_supported")) ?>,
            cameraAccessError: <?= $jsText(t("modules.clientes.messages.camera_access_error")) ?>,
            cameraPermissionDenied: <?= $jsText(t("modules.clientes.messages.camera_permission_denied")) ?>,
            cameraNotFound: <?= $jsText(t("modules.clientes.messages.camera_not_found")) ?>,
            cameraInitializing: <?= $jsText(t("modules.clientes.messages.camera_initializing")) ?>,
            cameraWaitInit: <?= $jsText(t("modules.clientes.messages.camera_wait_init")) ?>,
            cameraPermissionDeniedShort: <?= $jsText(t("modules.clientes.messages.camera_permission_denied_short")) ?>,
            cameraErrorAccess: <?= $jsText(t("modules.clientes.messages.camera_error_access")) ?>,
            cameraErrorStart: <?= $jsText(t("modules.clientes.messages.camera_error_start")) ?>,
            noInvoices: <?= $jsText(t("modules.clientes.invoices.no_invoices")) ?>,
            income: <?= $jsText(t("modules.clientes.invoices.income")) ?>,
            expense: <?= $jsText(t("modules.clientes.invoices.expense")) ?>,
            paid: <?= $jsText(t("modules.clientes.invoices.paid")) ?>,
            pending: <?= $jsText(t("modules.clientes.invoices.pending")) ?>,
            entry: <?= $jsText(t("modules.clientes.invoices.entry")) ?>,
            thisEntry: <?= $jsText(t("modules.clientes.invoices.this_entry")) ?>,
            sendChargeWhatsapp: <?= $jsText(t("modules.clientes.invoices.send_charge_whatsapp")) ?>,
            ...
            errorDeletingEntry: <?= $jsText(t("modules.clientes.messages.error_deleting_entry")) ?>,
            errorUnknown: <?= $jsText(t("modules.clientes.messages.error_unknown")) ?>,
            errorSending: <?= $jsText(t("modules.clientes.messages.error_sending")) ?>,
            errorDeleting: <?= $jsText(t("modules.clientes.messages.error_deleting")) ?>,
            connectionError: <?= $jsText(t("modules.clientes.messages.connection_error")) ?>,
            errorSaving: <?= $jsText(t("modules.clientes.messages.error_saving")) ?>,
            fillNameBeforeSave: <?= $jsText(t("modules.clientes.messages.fill_name_before_save")) ?>,
            noEmail: <?= $jsText(t("modules.clientes.messages.no_email")) ?>,
            noPhone: <?= $jsText(t("modules.clientes.messages.no_phone")) ?>,
            ...
            whatsappCheckError: <?= $jsText(t("modules.clientes.messages.whatsapp_check_error")) ?>,
            tooltipRemove: <?= $jsText(t("modules.clientes.tooltips.remove")) ?>,
            tooltipViewFile: <?= $jsText(t("modules.clientes.tooltips.view_file")) ?>,
            tooltipDeleteFile: <?= $jsText(t("modules.clientes.tooltips.delete_file")) ?>,
            noFiles: <?= $jsText(t("modules.clientes.documents.no_files")) ?>,
            selectFileTypeFirst: <?= $jsText(t("modules.clientes.messages.select_file_type_first")) ?>,
            fillFileName: <?= $jsText(t("modules.clientes.messages.fill_file_name")) ?>,
            fillFileTypeAndName: <?= $jsText(t("modules.clientes.messages.fill_file_type_and_name")) ?>,
            fileFormatNotAllowed: <?= $jsText(t("modules.clientes.messages.file_format_not_allowed")) ?>,
            errorUploadingFile: <?= $jsText(t("modules.clientes.messages.error_uploading_file")) ?>,
            errorDeletingFile: <?= $jsText(t("modules.clientes.messages.error_deleting_file")) ?>,
            cameraSelectTypeFirst: <?= $jsText(t("modules.clientes.messages.camera_select_type_first")) ?>,
            cameraFillNameFirst: <?= $jsText(t("modules.clientes.messages.camera_fill_name_first")) ?>,
            cameraNoneFound: <?= $jsText(t("modules.clientes.camera.not_found")) ?>,
            cameraDevice: <?= $jsText(t("modules.clientes.camera.device")) ?>,
            noCards: <?= $jsText(t("modules.clientes.credit_cards.no_cards")) ?>,
            cardAdded: <?= $jsText(t("modules.clientes.messages.card_added")) ?>,
            cardDeactivated: <?= $jsText(t("modules.clientes.messages.card_deactivated")) ?>,
            cardSetDefault: <?= $jsText(t("modules.clientes.messages.card_set_default")) ?>,
            errorAddingCard: <?= $jsText(t("modules.clientes.messages.error_adding_card")) ?>,
            cardTokenizationError: <?= $jsText(t("modules.clientes.messages.card_tokenization_error")) ?>,
            cardProcessing: <?= $jsText(t("modules.clientes.credit_cards.processing")) ?>,
            saveCard: <?= $jsText(t("modules.clientes.credit_cards.save_card")) ?>,
            fillCardHolder: <?= $jsText(t("modules.clientes.messages.fill_card_holder")) ?>,
            fillCardNumber: <?= $jsText(t("modules.clientes.messages.fill_card_number")) ?>,
            fillCardExpiry: <?= $jsText(t("modules.clientes.messages.fill_card_expiry")) ?>,
            fillCardCvv: <?= $jsText(t("modules.clientes.messages.fill_card_cvv")) ?>,
            fillCardGateway: <?= $jsText(t("modules.clientes.messages.fill_card_gateway")) ?>,
            fillCardHolderDocument: <?= $jsText(t("modules.clientes.messages.fill_card_holder_document")) ?>,
            tooltipDeactivateCard: <?= $jsText(t("modules.clientes.tooltips.deactivate_card")) ?>,
            tooltipSetDefaultCard: <?= $jsText(t("modules.clientes.tooltips.set_default_card")) ?>,
            noGateways: <?= $jsText(t("modules.clientes.credit_cards.no_gateways")) ?>,
        ...
        const visibilidadeCampos = {
            PF: {
                campoDocumento: { show: true, label: <?= $jsText(t("modules.clientes.fields.cpf")) ?>, required: true, placeholder: '000.000.000-00' },
                campoNome: { show: true, label: <?= $jsText(t("modules.clientes.fields.full_name")) ?>, required: true },
                campoNomeFantasia: { show: false },
                campoRG: { show: true, label: <?= $jsText(t("modules.clientes.fields.rg")) ?> },
            ...
            PJ: {
                campoDocumento: { show: true, label: <?= $jsText(t("modules.clientes.fields.cnpj")) ?>, required: true, placeholder: '00.000.000/0000-00' },
                campoNome: { show: true, label: <?= $jsText(t("modules.clientes.fields.company_name")) ?>, required: true },
                campoNomeFantasia: { show: true },
                campoRG: { show: true, label: <?= $jsText(t("modules.clientes.fields.ie")) ?> },
            ...
            ES: {
                campoDocumento: { show: true, label: <?= $jsText(t("modules.clientes.fields.passport")) ?>, required: true, placeholder: '' },
                campoNome: { show: true, label: <?= $jsText(t("modules.clientes.fields.full_name")) ?>, required: true },
                campoNomeFantasia: { show: false },
                campoRG: { show: false },
                campoNascimento: { show: true },
        ...
        function preencherFormularioCliente(data) {
            ...
            if (data.id_matriz_filial && data.filial_nome) {
                ...
                select.innerHTML = `<option value="">${escapeHtml(i18n.selectOption)}...</option><option value="${data.id_matriz_filial}" selected>${escapeHtml(data.filial_nome)}</option>`;
