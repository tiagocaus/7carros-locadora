...
<script>
    (function() {
        const i18n = {
            ...
            serverError: '<?= addslashes(t('modules.promocoes.messages.server_error')) ?>',
            noRecords: '<?= addslashes(t('modules.promocoes.messages.no_records')) ?>',
            noName: '<?= addslashes(t('modules.promocoes.messages.no_name')) ?>',
            allBranches: '<?= addslashes(t('modules.promocoes.messages.all_branches')) ?>',
            daysSuffix: '<?= addslashes(t('modules.promocoes.messages.days_suffix')) ?>',
            typePercentage: '<?= addslashes(t('modules.promocoes.badges.type_percentage')) ?>',
            typeFixed: '<?= addslashes(t('modules.promocoes.badges.type_fixed')) ?>',
            statusActive: '<?= addslashes(t('modules.promocoes.badges.status_active')) ?>',
            statusInactive: '<?= addslashes(t('modules.promocoes.badges.status_inactive')) ?>',
            actionEdit: '<?= addslashes(t('common.buttons.edit')) ?>',
            actionDelete: '<?= addslashes(t('common.buttons.delete')) ?>',
            thisRecord: '<?= addslashes(t('modules.promocoes.messages.this_record')) ?>',
            recordType: '<?= addslashes(t('modules.promocoes.record_type')) ?>',
            deleteError: '<?= addslashes(t('modules.promocoes.messages.delete_error')) ?>',
            showingPagination: '<?= addslashes(t('modules.promocoes.pagination.showing')) ?>',
        };
