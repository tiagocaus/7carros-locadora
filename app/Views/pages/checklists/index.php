...
<script>
    (function() {
        const i18n = {
            ...
            loadError: '<?= addslashes(t('modules.checklists.messages.load_error')) ?>',
            serverError: '<?= addslashes(t('modules.checklists.messages.server_error')) ?>',
            noRecords: '<?= addslashes(t('modules.checklists.messages.no_records')) ?>',
            deleteError: '<?= addslashes(t('modules.checklists.messages.delete_error')) ?>',
            thisRecord: '<?= addslashes(t('modules.checklists.messages.this_record')) ?>',
            recordType: '<?= addslashes(t('modules.checklists.record_type')) ?>',
            typeLinked: '<?= addslashes(t('modules.checklists.types.linked')) ?>',
            typeStandalone: '<?= addslashes(t('modules.checklists.types.standalone')) ?>',
            actionPrint: '<?= addslashes(t('common.buttons.print')) ?>',
            actionDelete: '<?= addslashes(t('common.buttons.delete')) ?>',
            printLandscape: '<?= addslashes(t('modules.checklists.print.landscape')) ?>',
            printPortrait: '<?= addslashes(t('modules.checklists.print.portrait')) ?>',
            printTitlePrefix: '<?= addslashes(t('modules.checklists.print.title_prefix')) ?>',
            showingPagination: '<?= addslashes(t('modules.checklists.pagination.showing')) ?>',
            ...
            statusContinue: '<?= addslashes(t('modules.checklists.digital.continue')) ?>',
            mobileOnly: '<?= addslashes(t('modules.checklists.messages.mobile_only')) ?>',
        };
