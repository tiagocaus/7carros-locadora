...
(function() {
    const i18n = {
        ...
        invalidImageFormat: <?= js_t('modules.grupos.messages.invalid_image_format') ?>,
        imageTooLarge: <?= js_t('modules.grupos.messages.image_too_large') ?>,
        ...
        hintPercentageRental: <?= js_t('modules.grupos.commission_hints.percentage_rental') ?>,
        hintFixedRentalInvoice: '<?= addslashes(t('modules.grupos.commission_hints.fixed_rental_invoice')) ?>',
        hintFixedRentalMonthly: <?= js_t('modules.grupos.commission_hints.fixed_rental_monthly') ?>,
        hintFixedInvestorMonthly: <?= js_t('modules.grupos.commission_hints.fixed_investor_monthly') ?>,
