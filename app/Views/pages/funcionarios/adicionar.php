...
<script>
    (function() {
        const i18n = {
            ...
            imageTooLarge: '<?= addslashes(t('modules.funcionarios.messages.image_too_large')) ?>',
            cameraNotSupported: '<?= addslashes(t('modules.funcionarios.messages.camera_not_supported')) ?>',
            cameraAccessDenied: '<?= addslashes(t('modules.funcionarios.messages.camera_access_denied')) ?>',
            cameraNotFound: '<?= addslashes(t('modules.funcionarios.messages.camera_not_found')) ?>',
            ...
            nameSupportError: '<?= addslashes(t('modules.funcionarios.messages.name_support_error')) ?>',
            usernameSupportError: '<?= addslashes(t('modules.funcionarios.messages.username_support_error')) ?>',
            ...
            updateError: '<?= addslashes(t('modules.funcionarios.messages.update_error')) ?>',
            ...
            branchSelect: '<?= addslashes(t('modules.funcionarios.placeholders.select_option')) ?>',
        };
