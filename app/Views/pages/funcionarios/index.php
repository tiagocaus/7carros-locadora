...
(function () {
    const i18n = {
        loadError: '<?= addslashes(t('modules.funcionarios.messages.load_error')) ?>',
        serverError: '<?= addslashes(t('modules.funcionarios.messages.server_error')) ?>',
        noRecords: '<?= addslashes(t('modules.funcionarios.messages.no_records')) ?>',
        unnamed: '<?= addslashes(t('modules.funcionarios.messages.unnamed')) ?>',
        thisEmployee: '<?= addslashes(t('modules.funcionarios.messages.this_employee')) ?>',
        idNotFound: '<?= addslashes(t('modules.funcionarios.messages.id_not_found')) ?>',
        deleteError: '<?= addslashes(t('modules.funcionarios.messages.delete_error')) ?>',
        statusActive: '<?= addslashes(t('modules.funcionarios.status_options.active')) ?>',
        statusInactive: '<?= addslashes(t('modules.funcionarios.status_options.inactive')) ?>',
        actionView: '<?= addslashes(t('modules.funcionarios.actions.view')) ?>',
        actionEdit: '<?= addslashes(t('modules.funcionarios.actions.edit')) ?>',
        actionDelete: '<?= addslashes(t('modules.funcionarios.actions.delete')) ?>',
        recordType: '<?= addslashes(t('modules.funcionarios.record_type')) ?>',
        showingPagination: '<?= addslashes(t('modules.funcionarios.pagination.showing')) ?>',
        deleteModalTitle: '<?= addslashes(t('modules.funcionarios.delete_modal.title')) ?>',
        deleteModalConfirmText: '<?= addslashes(t('modules.funcionarios.delete_modal.confirm_text')) ?>',
        deleteModalThisRecord: '<?= addslashes(t('modules.funcionarios.delete_modal.this_record')) ?>',
        deleteModalMessage: '<?= addslashes(t('modules.funcionarios.delete_modal.message')) ?>',
        deleteModalTypePlaceholder: '<?= addslashes(t('modules.funcionarios.delete_modal.type_placeholder')) ?>',
    };
