...
(function() {
    const i18n = {
        ...
        voteError: <?= js_t('modules.feature_requests.messages.vote_error') ?>,
        ...
        processError: <?= js_t('modules.feature_requests.messages.process_error') ?>,
        ...
        updateError: <?= js_t('modules.feature_requests.messages.update_error') ?>,
        updateRequestError: <?= js_t('modules.feature_requests.messages.update_request_error') ?>,
