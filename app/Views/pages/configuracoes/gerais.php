        ...
        <div class="form-section mb-6">
            ...
            <div class="mt-4">
                <h4 class="text-xs font-semibold uppercase tracking-wide text-slate-500 mb-2">
                    <?= t('modules.configuracoes_gerais.notifications.financial_automation') ?>
                </h4>
                <div class="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                    <div>
                        <h4 class="font-medium"><?= t('modules.configuracoes_gerais.notifications.overdue_billing_title') ?></h4>
                        <p class="text-sm text-slate-500"><?= t('modules.configuracoes_gerais.notifications.overdue_billing_desc') ?></p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" id="notificacao_cobranca_vencida" name="notificacao_cobranca_vencida" value="S" class="sr-only peer">
                        <div class="w-11 h-6 bg-slate-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                    </label>
                </div>
            </div>
...
(function() {
    ...
    function preencherFormulario(data) {
        ...
        document.getElementById('notificacao_cobranca_vencida').checked = data.notificacao_cobranca_vencida === 'S';
