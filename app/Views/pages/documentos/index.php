...
(function () {
    const i18n = {
        ...
        loadError: '<?= addslashes(t('modules.documentos.messages.load_error')) ?>',
        serverError: '<?= addslashes(t('modules.documentos.messages.server_error')) ?>',
        noRecords: '<?= addslashes(t('modules.documentos.messages.no_records')) ?>',
        noTitle: '<?= addslashes(t('modules.documentos.messages.no_title')) ?>',
        typeBoth: '<?= addslashes(t('modules.documentos.badges.type_both')) ?>',
        typeContract: '<?= addslashes(t('modules.documentos.badges.type_contract')) ?>',
        typeRental: '<?= addslashes(t('modules.documentos.badges.type_rental')) ?>',
        typeFine: '<?= addslashes(t('modules.documentos.badges.type_fine')) ?>',
        statusActive: '<?= addslashes(t('modules.documentos.badges.status_active')) ?>',
        statusInactive: '<?= addslashes(t('modules.documentos.badges.status_inactive')) ?>',
        actionEdit: '<?= addslashes(t('common.buttons.edit')) ?>',
        actionDelete: '<?= addslashes(t('common.buttons.delete')) ?>',
        thisRecord: '<?= addslashes(t('modules.documentos.messages.this_record')) ?>',
        recordType: '<?= addslashes(t('modules.documentos.record_type')) ?>',
        deleteError: '<?= addslashes(t('modules.documentos.messages.delete_error')) ?>',
        showingPagination: '<?= addslashes(t('modules.documentos.pagination.showing')) ?>',
    };
