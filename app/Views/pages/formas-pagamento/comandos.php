...
(function() {
    const i18n = {
        ...
        deleteError: '<?= addslashes(t('modules.formas_pagamento.commands.messages.delete_error')) ?>',
        deleteConfirm: '<?= addslashes(t('modules.formas_pagamento.commands.messages.delete_confirm')) ?>',
