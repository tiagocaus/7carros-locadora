                    ...
                    <div class="submenu submenu-multilevel">
                        ...
                        <div class="submenu-item-with-submenu">
                            ...
                            <div class="submenu-level-2">
                                ...
                                <?php if (\App\Core\Auth::can('relatorios.veicular.historico_odometros')): ?>
                                <a href="#" onclick="openOrSwitchToTab('/pages/relatorios/veicular/historico-odometros', '<?= t('modules.relatorios.veicular.historico_odometros.title') ?>', 'fas fa-tachometer-alt'); return false;"><?= t('modules.relatorios.veicular.historico_odometros.title') ?></a>
                                <?php endif; ?>
