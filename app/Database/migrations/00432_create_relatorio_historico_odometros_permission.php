...
/**
 * Permissao do relatorio Veicular > Historico de Odometros.
 */
return new class extends Migration
{
    private const PERMISSION_KEY = 'relatorios.veicular.historico_odometros';
    ...
    public function up(): void
    {
        ...
        if (!$permission) {
            $permissionId = $this->db()->table('permissions')->insert([
                ...
                'name' => 'Relatorio Historico de Odometros',
                'description' => 'Consultar e exportar todas as leituras individuais de odometro dos contratos',
                'module' => 'relatorios',
            ]);
        } else {
