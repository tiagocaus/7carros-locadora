...
/**
 * Migration 00395: Adicionar permissao dedicada para gerenciar acesso ao suporte.
 */
...
return new class extends Migration
{
    private const PERMISSION = [
        'key' => 'suporte.gerenciar',
        'name' => 'Gerenciar Acesso ao Suporte',
        'description' => 'Criar e remover usuario temporario para acesso da equipe de suporte',
        'module' => 'suporte',
    ];
