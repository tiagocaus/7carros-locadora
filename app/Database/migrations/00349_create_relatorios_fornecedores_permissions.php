...
/**
 * Migration: Permissoes do Lote F1 da categoria Fornecedores (relatorios 9.1, 9.2).
 *   - relatorios.fornecedores.compras
 *   - relatorios.fornecedores.investidor
 *
...
return new class extends Migration
{
    ...
    {
        return [
            ['key' => 'relatorios.fornecedores.compras', 'name' => 'Relatorio Compras e Pagamentos', 'description' => 'Visualizar compras/pagamentos por fornecedor (qtd, valor total, ticket medio, ultima compra)', 'module' => 'relatorios'],
            ['key' => 'relatorios.fornecedores.investidor', 'name' => 'Relatorio Fornecedor Investidor', 'description' => 'Visualizar fornecedores investidores: veiculos cedidos, receita gerada, comissao devida vs paga', 'module' => 'relatorios'],
        ];
    }
};
