...
return [
    'diagram' => [
        'label' => 'Diagram',
        'hint' => 'Used in the printed checklist. Open the list to preview diagrams.',
        'preview_unavailable' => 'Preview unavailable',
        'unavailable' => 'Diagram unavailable',
        'invalid' => 'Select a valid diagram.',
        'close' => 'Close preview',
        'options' => [
            'atv' => 'ATV',
            'caravana' => 'Caravan',
            'cargo' => 'Cargo van',
            'convercivel' => 'Convertible',
            'coupe' => 'Coupe',
            'crossover' => 'Crossover',
            'golfcart' => 'Golf cart',
            'hatch' => 'Hatchback',
            'hatch4drs' => '4-door hatchback',
            'hibrido' => 'Hybrid',
            'jeep' => 'Jeep',
            'microvan' => 'Microvan',
            'minicargo' => 'Mini cargo van',
            'minisuv' => 'Mini SUV',
            'minivan' => 'Minivan',
            'moto' => 'Motorbike',
            'motocicleta' => 'Motorcycle',
            'pickupcabinedupla' => 'Double cab pickup',
            'pickupcabinesimples' => 'Single cab pickup',
            'scooter' => 'Scooter',
            'sedan' => 'Sedan',
            'shuttle' => 'Shuttle',
            'sport' => 'Sports car',
