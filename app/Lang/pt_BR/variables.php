...
return [
    ...
    'installment_command' => [
        ...
        'single_day' => 'Pagamento único com vencimento em :days dia',
        'single_days' => 'Pagamento único com vencimento em :days dias',
        'monthly_range' => 'Parcelamento mensal de :min a :max parcelas',
        'fixed' => ':count parcelas com vencimentos em :days dias',
        'fixed_with_upfront' => ':count parcelas: a primeira no ato e as demais em :days dias',
        'weekly' => 'semanal',
    ...
    'contrato' => [
        ...
        'comando_parcela' => 'Comando de Parcela (Texto Amigável)',
        ...
        'caucao_status' => 'Status da Caução',
        ...
        'bloqueio_status' => 'Status do Bloqueio',
        ...
        'parcelas_tabela_status' => 'Tabela de Parcelas com Status',
    ...
    'fatura' => [
        ...
        'parcela' => 'Parcela',
        'total_parcelas' => 'Total de Parcelas',
        'parcela_descricao' => 'Identificação da Parcela',
        'observacoes' => 'Observações',
    ],
    ...
    'descriptions' => [
        ...
        'contrato.parcelas_tabela' => 'Tabela HTML com parcelas sem status (Parcela, Vencimento e Valor)',
        'contrato.parcelas_tabela_status' => 'Tabela HTML com parcelas e status (Parcela, Vencimento, Valor e Status)',
