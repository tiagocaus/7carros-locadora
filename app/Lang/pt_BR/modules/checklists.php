...
return [
    ...
    'digital' => [
        ...
        'list' => 'Lista',
        'new' => 'Novo checklist',
        'new_standalone' => 'Avulso',
        'new_linked' => 'Vinculado',
        'linked_pending_title' => 'Checklists vinculados',
        'filter_status' => 'Status',
        'waiting_departure' => 'Aguardando saída',
        'waiting_arrival' => 'Aguardando chegada',
        'start_departure' => 'Fazer saída',
        'start_arrival' => 'Fazer chegada',
        ...
        'status_standalone_started' => 'Avulso iniciado',
        'status_standalone_done' => 'Avulso concluído',
        'status_linked_departure_started' => 'Vinculado saída iniciado',
        'status_linked_departure_done' => 'Vinculado saída concluído',
        'status_linked_arrival_started' => 'Vinculado chegada iniciado',
        'status_linked_arrival_done' => 'Vinculado chegada concluído',
