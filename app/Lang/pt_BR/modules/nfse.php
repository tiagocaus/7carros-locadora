...
return [
    ...
    'messages' => [
        ...
        'c_ind_op_ibscbs_invalid' => 'O cIndOp informado não é aceito pelo layout NT004 atualmente ativo na NFS-e.',
    ...
    'config' => [
        ...
        'preencher_ibscbs_hint' => 'Disponível para emissão Nacional e Betha. Ative somente com os códigos fiscais confirmados para a operação.',
        'c_ind_op_ibscbs' => 'Indicador da operação (cIndOp)',
        'c_ind_op_ibscbs_hint' => 'Código de 6 dígitos da tabela NT004 ativa em produção. Códigos da NT009 ainda não devem ser usados.',
