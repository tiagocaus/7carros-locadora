...
return [
    ...
    'config' => [
        ...
        'trib_fixo' => 'Fixo',
        'trib_isento' => 'Isento',
        'trib_nao_incide' => 'Não incide',
        'aliquota_iss' => 'Alíquota ISS (%)',
        'exigibilidade_iss' => 'Exigibilidade ISS',
        'incentivo_fiscal' => 'Incentivo Fiscal',
        'abrasf_item_lista' => 'Item da Lista de Serviços',
        'abrasf_cnae' => 'Código CNAE',
        'abrasf_trib_municipio' => 'Código Tributação Município',
        'abrasf_numero_rps' => 'Número RPS Atual',
        'abrasf_hint' => 'Campos obrigatórios quando tipo de emissão é ABRASF (Municipal)',
