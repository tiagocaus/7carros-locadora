...
return [
    'diagram' => [
        ...
        'options' => [
            ...
            'convercivel' => 'Conversível',
            'coupe' => 'Cupê',
            'crossover' => 'Crossover',
            'golfcart' => 'Carrinho de golfe',
            'hatch' => 'Hatch',
            'hatch4drs' => 'Hatch 4 portas',
            'hibrido' => 'Híbrido',
            'jeep' => 'Jipe',
            'microvan' => 'Microvan',
    ...
    'fraction_adjustment' => [
        ...
        'search_placeholder' => 'Placa, marca ou modelo',
        'group_filter' => 'Grupo',
        ...
        'types' => [
            'increase_percent' => 'Aumentar em percentual (%)',
            'decrease_percent' => 'Reduzir em percentual (%)',
        ...
        'confirm_message' => 'Você alterará o valor por fração de :count veículo(s). Os novos valores entram em vigor imediatamente e serão usados também nas devoluções futuras de contratos e locações que já estejam abertos.',
        'confirm_button' => 'Sim, salvar alterações',
        'branch_change_title' => 'Descartar alterações?',
        'branch_change_message' => 'Existem novos valores não salvos. Deseja descartá-los e trocar de filial?',
        'branch_change_button' => 'Sim, trocar filial',
        'messages' => [
            'permission_denied' => 'Você não tem permissão para editar veículos.',
            'branch_required' => 'Selecione uma filial.',
            'branch_denied' => 'Você não tem acesso a esta filial.',
            ...
            'percent_limit' => 'A redução percentual não pode ser maior que 100%.',
    ...
    'import_modal' => [
        ...
        'maintenance_plan' => 'Plano de Manutenção',
        'file' => 'Arquivo CSV',
        'file_hint' => 'Use o modelo oficial em CSV, com até 2 MB e 1.000 veículos. Os valores selecionados serão aplicados a todo o lote.',
        'select_branch' => 'Selecione a matriz/filial',
        'select_supplier' => 'Selecione o fornecedor',
        'select_group' => 'Selecione o grupo',
        'select_location' => 'Mesma da matriz/filial',
        ...
        'processing' => 'Validando e importando veículos...',
        ...
        'skipped_summary' => ':skipped placa(s) duplicada(s) ignorada(s):',
        'skipped_existing' => 'Linha :line — placa já cadastrada.',
        'skipped_file_duplicate' => 'Linha :line — placa repetida no arquivo.',
        'required_options' => 'Selecione matriz/filial, fornecedor, grupo e plano de manutenção.',
