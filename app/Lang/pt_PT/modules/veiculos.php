...
return [
    'diagram' => [
        'label' => 'Diagrama',
        'hint' => 'Utilizado no checklist impresso. Abra a lista para visualizar os diagramas.',
        'preview_unavailable' => 'Pré-visualização indisponível',
        'unavailable' => 'Diagrama indisponível',
        'invalid' => 'Selecione um diagrama válido.',
        'close' => 'Fechar pré-visualização',
        'options' => [
            'atv' => 'Quadriciclo',
            'caravana' => 'Caravana',
            'cargo' => 'Furgão de carga',
            'convercivel' => 'Descapotável',
            'coupe' => 'Coupé',
            'crossover' => 'Crossover',
            'golfcart' => 'Carrinho de golfe',
            'hatch' => 'Hatchback',
            'hatch4drs' => 'Hatchback 4 portas',
            'hibrido' => 'Híbrido',
            'jeep' => 'Jipe',
            'microvan' => 'Microvan',
            'minicargo' => 'Minifurgão',
            'minisuv' => 'Mini SUV',
            'minivan' => 'Monovolume',
            'moto' => 'Moto',
            'motocicleta' => 'Motociclo',
            'pickupcabinedupla' => 'Pickup cabine dupla',
            'pickupcabinesimples' => 'Pickup cabine simples',
            'scooter' => 'Scooter',
            'sedan' => 'Sedan',
            'shuttle' => 'Miniautocarro',
            'sport' => 'Desportivo',
            'suv' => 'SUV',
            'truck' => 'Camião',
            'van' => 'Carrinha de passageiros',
            'wagon' => 'Carrinha',
        ],
    ],
