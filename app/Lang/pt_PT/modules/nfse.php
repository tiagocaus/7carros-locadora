...
return [
    ...
    'config' => [
        ...
        'c_ind_op_ibscbs_hint' => 'Código oficial de 6 dígitos.',
        'cst_ibscbs' => 'CST IBS/CBS',
        'cst_ibscbs_hint' => 'Código de situação tributária com 3 dígitos.',
        'c_class_trib_ibscbs' => 'Classificação tributária (cClassTrib)',
        'c_class_trib_ibscbs_hint' => 'Código oficial de 6 dígitos compatível com o CST.',
