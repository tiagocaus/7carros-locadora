...
return [
    ...
    'sections' => [
        ...
        'billing_fees_desc' => 'Configure as taxas retidas pelo meio de pagamento. Na liquidação, o sistema regista a receita bruta e uma despesa separada. Deixe 0,00 para desativar.',
    ...
    'fields' => [
        ...
        'fee_account' => 'Plano de Contas da Taxa',
        'fee_account_hint' => 'Conta de despesa usada no lançamento automático. O gateway fica registado separadamente para análise.',
        'fee_account_default' => 'Padrão: 3.4.1.21 - Taxas de meios de pagamento',
    ...
    'commands' => [
        ...
        'fields' => [
            'command' => 'Comando',
            'command_hint' => 'Exemplos de uso:<br><br> <b>0</b> - Pagamento à vista. <br><br> <b>15</b> - Pagamento para daqui a 15 dias. <br><br> <b>1-12</b> - Gera prestação mensal de 1 a 12x. <br><br> <b>7/14/21/28</b> - Nesse exemplo é gerado 4 prestações com prazos estabelecidos. <br><br> <b>Seg</b> - Informe um único dia da semana para o vencimento. Opções: Dom, Seg, Ter, Qua, Qui, Sex ou Sab. <br><br> <b>d5, d10, d15, ...</b> - Qual dia do mês será o vencimento.<br><br> <b>w36</b> - Será criado 36 prestações semanais.<br><br> <b>w36-Seg</b> - Será criado 36 prestações semanais com o vencimento toda Segunda-feira.',
