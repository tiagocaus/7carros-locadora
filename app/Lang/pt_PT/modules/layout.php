...
$map = [
    ...
    'Confirmar exclusão' => 'Confirmar eliminação',
    'Verifique os campos' => 'Verifique os campos',
    'Por favor, corrija os seguintes campos:' => 'Por favor, corrija os seguintes campos:',
    ...
    'Não foi possível validar sua sessão. Entre novamente para continuar.' => 'Não foi possível validar a sua sessão. Inicie sessão novamente para continuar.',
    'Sua sessão expirou após quatro horas sem comunicação com o sistema. Entre novamente para continuar.' => 'A sua sessão expirou após quatro horas sem comunicação com o sistema. Inicie sessão novamente para continuar.',
    'O navegador mudou durante o acesso e a sessão foi encerrada por segurança. Entre novamente para continuar.' => 'O navegador mudou durante o acesso e a sessão foi terminada por segurança. Inicie sessão novamente para continuar.',
    'O identificador da sessão ficou inválido. Entre novamente para continuar.' => 'O identificador da sessão ficou inválido. Inicie sessão novamente para continuar.',
    'Não foi possível acessar o armazenamento da sessão. Entre novamente para continuar.' => 'Não foi possível aceder ao armazenamento da sessão. Inicie sessão novamente para continuar.',
    'O navegador não enviou o cookie da sessão. Entre novamente para continuar.' => 'O navegador não enviou o cookie da sessão. Inicie sessão novamente para continuar.',
    'Sua autenticação não está mais disponível. Entre novamente para continuar.' => 'A sua autenticação já não está disponível. Inicie sessão novamente para continuar.',
    ...
    'Ir para o login' => 'Ir para o início de sessão',
