...
return [
    'diagram' => [
        'label' => 'Diagrama',
        'hint' => 'Utilizado en el checklist impreso. Abra la lista para ver los diagramas.',
        'preview_unavailable' => 'Vista previa no disponible',
        'unavailable' => 'Diagrama no disponible',
        'invalid' => 'Seleccione un diagrama válido.',
        'close' => 'Cerrar vista previa',
        'options' => [
            'atv' => 'Quad',
            'caravana' => 'Caravana',
            'cargo' => 'Furgón de carga',
            'convercivel' => 'Descapotable',
            'coupe' => 'Cupé',
            'crossover' => 'Crossover',
            'golfcart' => 'Carrito de golf',
            'hatch' => 'Hatchback',
            'hatch4drs' => 'Hatchback 4 puertas',
            'hibrido' => 'Híbrido',
            'jeep' => 'Todoterreno',
            'microvan' => 'Microvan',
            'minicargo' => 'Minifurgón',
            'minisuv' => 'Mini SUV',
            'minivan' => 'Monovolumen',
            'moto' => 'Moto',
            'motocicleta' => 'Motocicleta',
            'pickupcabinedupla' => 'Pickup cabina doble',
            'pickupcabinesimples' => 'Pickup cabina simple',
            'scooter' => 'Scooter',
            'sedan' => 'Sedán',
            'shuttle' => 'Microbús',
            'sport' => 'Deportivo',
