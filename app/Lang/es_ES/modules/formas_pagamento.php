...
return [
    ...
    'sections' => [
        ...
        'billing_fees_desc' => 'Configure las tasas retenidas por el medio de pago. Al liquidar, el sistema registra el ingreso bruto y un gasto separado. Deje 0,00 para desactivar.',
    ...
    'fields' => [
        ...
        'fee_account' => 'Plan de Cuentas de la Tasa',
        'fee_account_hint' => 'Cuenta de gasto usada en el asiento automático. El gateway se registra por separado para análisis.',
        'fee_account_default' => 'Predeterminado: 3.4.1.21 - Tasas de medios de pago',
