...
class LocacaoBloqueio extends Model
{
    ...
    /**
     * Busca o bloqueio ativo (authorized) de uma locacao
     */
    public function buscarAtivoPorLocacao(int $idLocacao): ?array
    {
        return $this->qb
            ->table('locacoes_bloqueios')
    ...
    /**
     * Lista todos os bloqueios de uma locacao (historico)
     */
