...
$router->get('/webhook/santander', [PagamentoPublicoController::class, 'webhookSantanderInfo'], ['rate_limit']);
$router->get('/webhook/santander/pix', [PagamentoPublicoController::class, 'webhookSantanderInfo'], ['rate_limit']);
...
$router->post('/webhook/santander', [PagamentoPublicoController::class, 'webhookSantander'], ['rate_limit']);
$router->post('/webhook/santander/pix', [PagamentoPublicoController::class, 'webhookSantander'], ['rate_limit']);
...
$router->group(['middleware' => ['auth', 'web_system_access']], function ($router) {
    ...
    $router->post('/api/contratos/{id}/odometros/preview', [ContratosController::class, 'previewOdometro'], ['permission:contratos.editar', 'api_csrf', 'rate_limit', 'throttle']);
    $router->post('/api/contratos/{id}/odometros/fronteira', [ContratosController::class, 'fronteiraOdometro'], ['permission:contratos.editar', 'api_csrf', 'rate_limit', 'throttle']);
    ...
    $router->get('/pages/relatorios/veicular/historico-odometros', [\App\Controllers\Relatorios\VeicularController::class, 'viewHistoricoOdometros']);
    $router->get('/api/relatorios/veicular/historico-odometros', [\App\Controllers\Relatorios\VeicularController::class, 'historicoOdometros'], ['api_csrf', 'rate_limit', 'throttle']);
    $router->get('/relatorios/veicular/historico-odometros/pdf', [\App\Controllers\Relatorios\VeicularController::class, 'historicoOdometrosPdf']);
